	...
	<cffunction name="mergeProperties" returntype="any">
	  <cfargument name="fileName" type="String">
		<cfscript>
			...
			if(findNoCase(customPropertyBeginString, fileContent) && findNoCase(customPropertyEndString, fileContent)){
				
				var customPropertyStartPos = findNoCase(chr(9)&customPropertyBeginString, fileContent);
				
				var customPropertyEndPos = findNoCase(chr(9)&customPropertyEndString, fileContent) + len(customPropertyEndString);
